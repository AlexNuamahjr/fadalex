                ...
                <div className="row align-items-center">
                    <div className="col-lg-4 col-sm-6">
                        <div className="about-img">
                            <img src="/assets-clients/images/about/img-1.jpg" alt="" className="img-fluid"/>
                            <img src="/assets-clients/images/about/img-2.jpg" alt="" className="img-fluid mt-4"/>
                        </div>
                    </div>
                    <div className="col-lg-4 col-sm-6">
                        <div className="about-img mt-4 mt-lg-0">
                            <img src="/assets-clients/images/about/img-3.jpg" alt="" className="img-fluid"/>
                        </div>
                    </div>
